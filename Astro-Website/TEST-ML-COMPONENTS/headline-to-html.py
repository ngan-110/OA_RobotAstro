...
with open('Astro-Website/TEST-ML-COMPONENTS/links.txt','r',encoding='utf-8') as link_file:
    link_list = []
    for line in link_file:
        link_list.append(line)
    #print(link_list)

with open('Astro-Website/TEST-ML-COMPONENTS/headlines.txt','r',encoding='utf-8') as headline_file:
    headline_list = []
...
for bullet_index in range(len(link_list)):
    ...
    '''
    list_html += list_item
with open('Astro-Website/PAGES/ref-site-page.html','r',encoding='utf-8') as ref_page:
...
with open('Astro-Website/PAGES/ref-site-page.html','w',encoding='utf-8') as file:
